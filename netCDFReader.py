...
def print_data_for_user_input(file_path, cell_id_index, jday_index, layer_index):
    ...
    with Dataset(file_path, 'r') as nc:
        ...
        layernumber_size = nc.dimensions['Layer_N'].size
        ...
        print(f"{RED}\nData points for input indices (Cell_ID={cell_id_index+1}, Layer_N={layer_index+1}, Time={jday_index+1},):")
...
def main():
    file_path = '/Users/xiaoxug/CBP-Decipher/netCDF_Output/All_Var.nc'  # Replace with your actual NetCDF file path
